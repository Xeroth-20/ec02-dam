...
import dev.jx.ec02.AdoptMeApplication;
...
public class ImageRequester {
    ...
    public ImageRequester() {
        RequestQueue requestQueue = Volley.newRequestQueue(AdoptMeApplication.getAppContext());
        requestQueue.start();
    ...
    public static int getMaxByteSize() {
        DisplayMetrics displayMetrics = AdoptMeApplication.getAppContext().getResources().getDisplayMetrics();
